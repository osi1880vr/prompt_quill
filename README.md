...
* Sail the data Ocean, this allows you to sail along the vector distance through the ocean of prompts. It allowes you to take a automated journey and see the seven seas of data pushing out nice prompts you may not had the idea to even think about. It also alowes you to direct create images using the a1111/Forge API. Ahoy sailor, fair winds and following seas.
